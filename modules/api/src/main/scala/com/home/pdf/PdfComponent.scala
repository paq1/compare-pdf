...
import com.home.pdf.services.comparator.files.FileComparator
...
trait PdfComponent { self: BuiltInComponentsFromContext =>
  ...
  lazy val pdfCompareController = new PdfCompareController(fileComparator, controllerComponents)
